...
public class StudentRepo {
    ...
    public int insert(Student student) {
        ...
        values.put(Student.KEY_bz, student.bz);
        values.put(Student.KEY_bj, student.bj);
        values.put(Student.KEY_cd, student.cd);
        values.put(Student.KEY_cj, student.cj);
    ...
    public Student getStudentById(int Id){
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                student.email  =cursor.getInt(cursor.getColumnIndex(Student.KEY_email));
                student.age =cursor.getInt(cursor.getColumnIndex(Student.KEY_age));
                student.bz  =cursor.getInt(cursor.getColumnIndex(Student.KEY_bz));
                student.bj  =cursor.getInt(cursor.getColumnIndex(Student.KEY_bj));
                student.cd  =cursor.getInt(cursor.getColumnIndex(Student.KEY_cd));
                student.cj  =cursor.getInt(cursor.getColumnIndex(Student.KEY_cj));
            } while (cursor.moveToNext());
        }
